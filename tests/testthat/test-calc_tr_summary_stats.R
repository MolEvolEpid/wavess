test_that("calc_tr_summary_stats works", {
  ...
  ### calc_prop_survived(ape::read.tree(text=
  # "(t1:1,((t3:1,(t4:1,t2:1):1):1,t5:1):1);"),
  ### c('t1'=1,'t2'=1,'t3'=2,'t4'=3,'t5'=3))
  expect_equal(get_clusters(
    tr,
    c("t1" = 1, "t2" = 3, "t3" = 2, "t4" = 3, "t5" = 2)
  )$pure_subtree_info$subtr_size, c(1, 1, 2, 1))
  expect_equal(get_clusters(tr,
    c("t1" = 1, "t2" = 3, "t3" = 2, "t4" = 3, "t5" = 2),
  ...
  # note that this isn't necessarily what we want when computing proportion of
  # lineages that survived, but it's the way the function works
  expect_equal(
