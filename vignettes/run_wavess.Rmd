...
We go into more detail about analyzing the model output in a separate vignette (**LINK**)

## Load libraries and prepare input data

First, we have to load the wavess library and generate the input data. 
If you're interested in learning more about how to prepare the input data,
please see the [corresponding vignette](prepare_input_data). 
**TODO: LINK THIS THE CORRECT WAY**
...
more about how to analyze the output, please checkout this vignette 
**TODO: ADD LINK TO POST-PROCESSING VIGNETTTE**
...
in the prepare input data vignette (**LINK**)
...
turn latent cell dynamics off, although you can choose to set all of the 
latency-related parameters to zero if you'd like. 
