...
required_args_only <- run_wavess(
  inf_pop_size = inf_pop_size,
  samp_scheme = samp_scheme,
...
(`days_full_potency`), at which time it reaches full potency. Epitopes
...
turn latent cell dynamics off. [**NOTE: these are now rates, not
probabilities**]
