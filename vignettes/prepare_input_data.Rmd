...
well as a few others, and we will set the plotting theme:
...
```{r, calc_nt_sub_probs}
(nt_sub_probs <- calc_nt_sub_probs(as.matrix(hiv_env_flt_2022)))
```
...
```{r, write_sub_probs}
write_csv(nt_sub_probs, "input_data/nt_sub_probs.csv")
```
