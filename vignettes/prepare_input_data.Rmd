...
$$F=F_C*F_R*F_I$$
where $F_C$ is the conserved fitness cost, $F_R$ is the replicative fitness cost,
and $F_I$ is the immune fitness cost.
...
(`aa_epitope_length`), the maximum fitness cost of the epitope (`max_fit_cost`),
and the cost type (linear or random, see documentation for details).
