...
for this founder sequence (`conserved_sites`) for ease of use.
...
```{r, write_conserved}
write_csv(enframe(conserved_sites, name = "position", value = "nucleotide"), "input_data/conserved_sites.csv")
```
