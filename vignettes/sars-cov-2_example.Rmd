...
All other examples on this website are using the HIV-1 envelope gene.
...
and `vignette("run_wavess")`, respectively. In fact, we would recommend starting
there. 
...
about how to prepare the input data, please see the corresponding vignette
