...
- `recomb_rates`: file with one fewer rows than the length of the founder sequence.
The value in each row corresponds to the breakpoint-specific recombination rate 
along the sequence. Note that this rate is modeled as an effective recombination 
rate that includes the rate of co-infection followed by recombination. This file
is only needed if the recombination rate varies across the sequence.
...
recombination rate across the sequence)
